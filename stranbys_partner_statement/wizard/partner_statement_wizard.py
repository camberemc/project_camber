...
class PartnerStatementWizard(models.TransientModel):
    ...
    def button_export_pdf(self):
        """Export to PDF."""
        return self.env.ref('stranbys_partner_statement.action_print_partner_statement').report_action(self)

    def button_report_xlsx(self):
        return self.env.ref('stranbys_partner_statement.report_partner_statement_xlsx').report_action(self)
