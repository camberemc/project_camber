...
class InventoryReturn(models.Model):
    ...
    def confirm_move(self):
        ...
        picking_type_id = self.env['stock.picking.type'].browse(operation_id)
...
class InventoryReturnLine(models.Model):
    ...
    uom_id = fields.Many2one('uom.uom', related='product_id.uom_id', string='Unit of Measure', store = True)
